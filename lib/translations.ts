...
export const TRANSLATIONS: Record<string, Traducao> = {
  ...
  "Evento inválido.": { en: "Invalid event.", es: "Evento inválido." },
  ...
  "Pessoas do time · quem prefere o {n}º domingo vem primeiro": { en: "People on the team · those who prefer Sunday #{n} come first", es: "Personas del equipo · quien prefiere el {n}º domingo va primero" },
  "Buscando fora do time": { en: "Searching outside the team", es: "Buscando fuera del equipo" },
  "Buscar fora do time": { en: "Search outside the team", es: "Buscar fuera del equipo" },
  "Voltar ao time": { en: "Back to the team", es: "Volver al equipo" },
  "Filtrar pelo nome…": { en: "Filter by name…", es: "Filtrar por nombre…" },
  "Ninguém do time com esse nome.": { en: "Nobody on the team with that name.", es: "Nadie del equipo con ese nombre." },
  "Não deu pra carregar o time. Busque pelo nome.": { en: "Couldn't load the team. Search by name.", es: "No se pudo cargar el equipo. Buscá por nombre." },
  "prefere este domingo": { en: "prefers this Sunday", es: "prefiere este domingo" },
  "prefere esta semana do mês": { en: "prefers this week of the month", es: "prefiere esta semana del mes" },
  "prefere o {n}º domingo": { en: "prefers Sunday #{n}", es: "prefiere el {n}º domingo" },
  "prefere a {n}ª semana do mês": { en: "prefers week {n} of the month", es: "prefiere la {n}ª semana del mes" },
  "Você acompanha as escalas do seu time, sem alterar.": { en: "You follow your team's schedules without editing.", es: "Seguís las escalas de tu equipo sin editar." },
  "Ver escalas": { en: "View schedules", es: "Ver escalas" },
  "Meu domingo de preferência": { en: "My preferred Sunday", es: "Mi domingo de preferencia" },
  "Quem monta a escala vê você primeiro nos cultos desse domingo do mês. Não é bloqueio: você continua podendo ser escalado em qualquer data.": { en: "Whoever builds the schedule sees you first on that Sunday of the month. It's not a block: you can still be scheduled on any date.", es: "Quien arma la escala te ve primero en los cultos de ese domingo del mes. No es un bloqueo: podés seguir siendo escalado en cualquier fecha." },
  "Nenhum": { en: "None", es: "Ninguno" },
  "domingo": { en: "Sunday", es: "domingo" },
  "Não deu pra salvar. Tente de novo.": { en: "Couldn't save. Try again.", es: "No se pudo guardar. Intentá de nuevo." },
  ...
  "Bíblia": { en: "Bible", es: "Biblia" },
  "Mural": { en: "Community", es: "Mural" },
  "Inscrever-se": { en: "Join plan", es: "Inscribirse" },
  "Devocionais de semanas anteriores": { en: "Previous weeks' devotionals", es: "Devocionales de semanas anteriores" },
  "Mural da comunidade": { en: "Community wall", es: "Mural de la comunidad" },
  "Publicar anonimamente": { en: "Post anonymously", es: "Publicar anónimamente" },
  "Anônimo": { en: "Anonymous", es: "Anónimo" },
  "Referência bíblica (ex.: 1Cr 2.3)": { en: "Bible reference (e.g. 1Ch 2:3)", es: "Referencia bíblica (ej.: 1Cr 2.3)" },
  "Escreva seu comentário": { en: "Write your comment", es: "Escribe tu comentario" },
  "Falta pouco": { en: "Almost there", es: "Ya casi" },
  "Informe a referência e seu comentário.": { en: "Enter the reference and your comment.", es: "Indica la referencia y tu comentario." },
  "Compartilhe o que Deus falou. Para a comunidade, todas as publicações são anônimas.": { en: "Share what God spoke to you. All community posts are anonymous.", es: "Comparte lo que Dios te habló. Todas las publicaciones son anónimas." },
  "Compartilhar versículo no mural": { en: "Share verse on the community wall", es: "Compartir versículo en el mural" },
  "Compartilhar no mural": { en: "Share on the community wall", es: "Compartir en el mural" },
  "ALMEIDA LIVRE": { en: "PUBLIC-DOMAIN ALMEIDA", es: "ALMEIDA DE DOMINIO PÚBLICO" },
  "Escolha um livro": { en: "Choose a book", es: "Elige un libro" },
  "João Ferreira de Almeida · texto em domínio público": { en: "João Ferreira de Almeida · public-domain text", es: "João Ferreira de Almeida · texto de dominio público" },
  "CAPÍTULOS": { en: "CHAPTERS", es: "CAPÍTULOS" },
  "Não foi possível carregar este capítulo.": { en: "This chapter could not be loaded.", es: "No se pudo cargar este capítulo." },
  "Abre a publicação no mural": { en: "Opens a community wall post", es: "Abre una publicación en el mural" },
  "CAMINHOS DE LEITURA": { en: "READING PATHS", es: "RUTAS DE LECTURA" },
  "Planos devocionais": { en: "Devotional plans", es: "Planes devocionales" },
  "SEGUNDA A SEXTA": { en: "MONDAY TO FRIDAY", es: "LUNES A VIERNES" },
  "Ore assim": { en: "Pray like this", es: "Ora así" },
  "COMUNIDADE": { en: "COMMUNITY", es: "COMUNIDAD" },
  "Compartilhe com responsabilidade. Sua publicação será identificada com seu nome.": { en: "Share responsibly. Your post will display your name.", es: "Comparte con responsabilidad. Tu publicación mostrará tu nombre." },
  "O que esse texto falou com você?": { en: "What did this passage say to you?", es: "¿Qué te habló este texto?" },
  "Quem pode ver?": { en: "Who can see it?", es: "¿Quién puede verlo?" },
  "Quem serve comigo": { en: "People who serve with me", es: "Quienes sirven conmigo" },
  "Toda a igreja": { en: "The whole church", es: "Toda la iglesia" },
  "Publicar no mural": { en: "Post to the community wall", es: "Publicar en el mural" },
  "Publicando...": { en: "Posting...", es: "Publicando..." },
  "Publicações recentes": { en: "Recent posts", es: "Publicaciones recientes" },
  "Não foi possível publicar": { en: "Could not post", es: "No se pudo publicar" },
  "SUA JORNADA COM A PALAVRA": { en: "YOUR JOURNEY WITH THE WORD", es: "TU CAMINO CON LA PALABRA" },
  "Leia, reflita e guarde o que Deus falou com você.": { en: "Read, reflect, and keep what God spoke to you.", es: "Lee, reflexiona y guarda lo que Dios te habló." },
  "LER E ACOMPANHAR": { en: "READ AND FOLLOW", es: "LEER Y SEGUIR" },
  "Leia por livro e capítulo": { en: "Read by book and chapter", es: "Lee por libro y capítulo" },
  "Planos de leitura": { en: "Reading plans", es: "Planes de lectura" },
  "Escolha sua jornada diária": { en: "Choose your daily journey", es: "Elige tu camino diario" },
  "GUARDAR E REVISITAR": { en: "SAVE AND REVISIT", es: "GUARDAR Y REVISITAR" },
  "Comentários": { en: "Comments", es: "Comentarios" },
  "Converse com sua comunidade": { en: "Talk with your community", es: "Conversa con tu comunidad" },
  "Anotações e Marcações": { en: "Notes and Highlights", es: "Notas y Marcaciones" },
  "O que você guardou da Palavra": { en: "What you saved from the Word", es: "Lo que guardaste de la Palabra" },
  "Leituras da Bíblia": { en: "Bible reading", es: "Lecturas de la Biblia" },
  "Seu ritmo e planos concluídos": { en: "Your rhythm and completed plans", es: "Tu ritmo y planes completados" },
  "ESCOLHA SUA JORNADA": { en: "CHOOSE YOUR JOURNEY", es: "ELIGE TU CAMINO" },
  "Um caminho para cada ritmo": { en: "A path for every rhythm", es: "Un camino para cada ritmo" },
  "Abra uma opção e siga uma leitura por dia.": { en: "Open an option and follow one reading a day.", es: "Abre una opción y sigue una lectura al día." },
  "Uma mensagem breve para o seu dia": { en: "A brief message for your day", es: "Un mensaje breve para tu día" },
  "Cinco leituras, de segunda a sexta": { en: "Five readings, Monday through Friday", es: "Cinco lecturas, de lunes a viernes" },
  "Devocional da semana": { en: "Weekly devotional", es: "Devocional de la semana" },
  "A leitura preparada para esta semana": { en: "The reading prepared for this week", es: "La lectura preparada para esta semana" },
  "Plano indisponível": { en: "Plan unavailable", es: "Plan no disponible" },
  "Este plano ainda não tem uma leitura publicada.": { en: "This plan does not have a published reading yet.", es: "Este plan aún no tiene una lectura publicada." },
  "Conteúdo indisponível": { en: "Content unavailable", es: "Contenido no disponible" },
  "O Pense mais recente ainda não carregou.": { en: "The latest Pense has not loaded yet.", es: "El Pense más reciente aún no cargó." },
  "Marcação salva": { en: "Highlight saved", es: "Marcación guardada" },
  "Você encontra esse texto em Anotações e Marcações.": { en: "You can find this text under Notes and Highlights.", es: "Encuentras este texto en Notas y Marcaciones." },
  "Não foi possível salvar": { en: "Could not save", es: "No se pudo guardar" },
  "João Ferreira de Almeida · domínio público": { en: "João Ferreira de Almeida · public domain", es: "João Ferreira de Almeida · dominio público" },
  "Marcar versículo": { en: "Highlight verse", es: "Marcar versículo" },
  "Para mim": { en: "For me", es: "Para mí" },
  "Pesquisar livro": { en: "Search books", es: "Buscar libro" },
  "Antigo Testamento": { en: "Old Testament", es: "Antiguo Testamento" },
  "Novo Testamento": { en: "New Testament", es: "Nuevo Testamento" },
  "Selecionar versículo": { en: "Select verse", es: "Seleccionar versículo" },
  "Marcar": { en: "Highlight", es: "Marcar" },
  "Anotações do devocional": { en: "Devotional notes", es: "Notas del devocional" },
  "Assista ao Pense": { en: "Watch Pense", es: "Ver Pense" },
  "Assista ao último vídeo": { en: "Watch the latest video", es: "Ver el último video" },
  "Pense · Pr. Pedrão": { en: "Pense · Pastor Pedrão", es: "Pense · Pr. Pedrão" },
  "Suas reflexões privadas, marcações e comentários publicados ficam reunidos aqui.": { en: "Your private reflections, highlights, and published comments are gathered here.", es: "Tus reflexiones privadas, marcaciones y comentarios publicados están reunidos aquí." },
  "Nova anotação para mim": { en: "New note for me", es: "Nueva nota para mí" },
  "Referência bíblica": { en: "Bible reference", es: "Referencia bíblica" },
  "Escreva o que você quer guardar": { en: "Write what you want to remember", es: "Escribe lo que quieres guardar" },
  "Salvar para mim": { en: "Save for me", es: "Guardar para mí" },
  "Nada guardado ainda": { en: "Nothing saved yet", es: "Nada guardado todavía" },
  "Toque em um versículo para anotar ou marcar.": { en: "Tap a verse to note or highlight it.", es: "Toca un versículo para anotarlo o marcarlo." },
  "Informe a referência e sua anotação.": { en: "Enter the reference and your note.", es: "Indica la referencia y tu nota." },
  "Excluir anotação?": { en: "Delete note?", es: "¿Eliminar nota?" },
  "Essa ação não pode ser desfeita.": { en: "This action cannot be undone.", es: "Esta acción no se puede deshacer." },
  "Excluir": { en: "Delete", es: "Eliminar" },
  "Só para mim": { en: "Only me", es: "Solo para mí" },
  "NESTE MÊS": { en: "THIS MONTH", es: "ESTE MES" },
  "dia com leitura da Bíblia": { en: "day reading the Bible", es: "día leyendo la Biblia" },
  "dias com leitura da Bíblia": { en: "days reading the Bible", es: "días leyendo la Biblia" },
  "dias registrados no total": { en: "total days recorded", es: "días registrados en total" },
  "Leituras recentes": { en: "Recent readings", es: "Lecturas recientes" },
  "Quando você abrir um capítulo, ele aparecerá aqui.": { en: "When you open a chapter, it will appear here.", es: "Cuando abras un capítulo, aparecerá aquí." },
  "Planos concluídos": { en: "Completed plans", es: "Planes completados" },
  "Seus planos concluídos aparecerão aqui.": { en: "Your completed plans will appear here.", es: "Tus planes completados aparecerán aquí." },
  "Em andamento": { en: "In progress", es: "En curso" },
  "Comentários da comunidade": { en: "Community comments", es: "Comentarios de la comunidad" },
  "Publicar comentário": { en: "Post comment", es: "Publicar comentario" },
  "Anterior": { en: "Previous", es: "Anterior" },
  "Versão da Bíblia": { en: "Bible version", es: "Versión de la Biblia" },
  "domínio público": { en: "public domain", es: "dominio público" },
  "Remover marcação": { en: "Remove highlight", es: "Quitar marcación" },
  "Marcação removida": { en: "Highlight removed", es: "Marcación eliminada" },
  "Não foi possível remover": { en: "Could not remove", es: "No se pudo eliminar" },
};
